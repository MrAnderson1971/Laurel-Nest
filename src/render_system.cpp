...
////    );
//    projection = glm::ortho(
//            0.0f, static_cast<float>(window_width_px_) / x_scale, // Left and right
//            static_cast<float>(window_height_px_) / y_scale, 0.0f, // Bottom and top
//            0.0f, 1.0f  // Near and far planes
//    );
//
//    glEnable(GL_BLEND);
...
//        glfwGetWindowSize(window, &window_width, &window_height);
//
//        float x_scale = static_cast<float>(fb_width) / static_cast<float>(window_width);
//        float y_scale = static_cast<float>(fb_height) / static_cast<float>(window_height);
//
//        // Update the projection matrix while keeping the aspect ratio
//        float aspect_ratio = static_cast<float>(window_width) / static_cast<float>(window_height);
//        glm::mat4 projection = glm::ortho(
//                0.0f, static_cast<float>(window_width) / x_scale,
//                static_cast<float>(window_height) / y_scale, 0.0f,
//                0.0f, 1.0f
//        );
//
//        // Set the updated projection matrix (assuming you use a shader program)
//        // glUniformMatrix4fv(projection_location, 1, GL_FALSE, &projection[0][0]);
//    });
//
//    return true;
