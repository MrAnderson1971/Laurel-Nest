...
float WALKING_CHICKEN_WIDTH = 0.58 * 866.f;
float WALKING_CHICKEN_HEIGHT = 0.58 * 867.f;
float IDLE_CHICKEN_WIDTH = 0.58 * 1059.f;
float IDLE_CHICKEN_HEIGHT = 0.58 * 866.f;
float PECK_CHICKEN_WIDTH = 0.58 * 1059.f;
float PECK_CHICKEN_HEIGHT = 0.58 * 866.f;
float HIT_CHICKEN_WIDTH = 0.59 * 786.f;
float HIT_CHICKEN_HEIGHT = 0.59 * 846.f;
float DEATH_CHICKEN_WIDTH = 0.6 * 960.f;
float DEATH_CHICKEN_HEIGHT = 0.6 * 565.f;
